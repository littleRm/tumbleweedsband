...
add_filter( 'rwmb_meta_boxes', 'tw_register_meta_boxes' );

/**
 * Register meta boxes
 *
 * Remember to change "tw" to actual prefix in your project
 *
 * @param array $meta_boxes List of meta boxes
 *
 * @return array
 */
function tw_register_meta_boxes( $meta_boxes )
{
	/**
	...
	//home page slide show meta box
	if($post_id == 38){ //home page only
		$meta_boxes[] = array(
			// Meta box id, UNIQUE per meta box. Optional since 4.1.5
			'id'         => 'home_slides',
	
			// Meta box title - Will appear at the drag and drop handle bar. Required.
			'title'      => __( 'Slideshow', 'meta-box' ),
			...
			'fields'     => array(
				...
				array(
					'name'             => __( 'Choose Slides', 'meta-box' ),
					'id'               => "{$prefix}slides",
					'type'             => 'file_advanced',
					'max_file_uploads' => 6,
				...
				array(
					...
					'desc' => __( 'The quote that appears under the slideshow', 'meta-box' ),
					'id'   => "{$prefix}quote",
					'type' => 'textarea',
					'cols' => 20,
					'rows' => 3,
				...
				// TEXT
				array(
					'name'  => __( 'Quote Source', 'meta-box' ),
					'id'    => "{$prefix}quote_source",
					'desc'  => __( 'Source of above quote', 'meta-box' ),
					'type'  => 'text'
				)
			)
		);
		$meta_boxes[] = array(
			...
			// Meta box title - Will appear at the drag and drop handle bar. Required.
			'title'      => __( 'Right Column', 'meta-box' ),
			...
			'fields'     => array(
				// TEXT
				array(
					'name'  => __( 'Header', 'meta-box' ),
					'id'    => "{$prefix}right_header",
					'type'  => 'text',
					'std'   => __( 'Listen', 'meta-box' )
				),
	...
	$meta_boxes[] = array(
		...
		// Meta box title - Will appear at the drag and drop handle bar. Required.
		'title'      => __( 'Meta Box Demo', 'meta-box' ),
